...
Developed a full-stack RAG application that converts GitHub repositories into searchable knowledge bases, enabling developers to query codebases using natural language.
